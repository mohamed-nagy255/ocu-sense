                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" type="text" placeholder="Enter patient name...">
                        </div>
                    </div>
                    <input type="hidden" name="my_date" value="{{ date('y,m,d') }}">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Age</label>
                            <input class="form-control" name="age" type="text" placeholder="Enter patient age...">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Data Of Birth</label>
                            <input class="form-control" name="date_birth" type="date">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <input type="radio" id="html1" name="diabetes" value="YES">
                            <label for="html1">YES</label>
                            <span style="padding: 0 20px;"> OR </span>
                            <input type="radio" id="css1" name="diabetes" value="NO">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alleragies" placeholder="Enter alleragies of ...">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Other Medical Conditions</label>
                            <textarea name="medical" cols="30" rows="10" class="form-control">
                        
                    </textarea>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary">Enter Patient</button>
            </form>
        </div>
    @endif 
